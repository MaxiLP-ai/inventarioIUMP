...
class Cuerpo(models.Model):
    ...
    imagen = CloudinaryField(default='default_ajqgij', verbose_name="Imagen del Cuerpo")
...
class Producto(models.Model):
    ...
    imagen = CloudinaryField(default='default_ajqgij', verbose_name="Imagen del Producto")
